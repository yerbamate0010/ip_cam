...
def load_settings():
    ...
    return Settings(
        ...
        confidence=_env_float("YOLO_CONF", 0.25),
        target_labels=tuple(sorted(labels)),
        evidence_fps=_env_float("EVIDENCE_FPS", 0),
        idle_detect_seconds=_env_float("IDLE_DETECT_SECONDS", 2.0),
        active_detect_seconds=_env_float("ACTIVE_DETECT_SECONDS", 0.5),
        active_track_seconds=_env_float("ACTIVE_TRACK_SECONDS", 12.0),
        post_roll_seconds=_env_int("POST_ROLL_SECONDS", 60),
