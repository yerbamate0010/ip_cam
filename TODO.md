...
- [ ] Dodac panel ustawien detekcji poza kompaktowym statusem.
- [ ] Dodac osobne progi confidence dla `person` i `dog`.
- [ ] Dodac wybor szerokosci YOLO: `960`, `1280`, `1536`, `auto`.
- [ ] Dodac ustawienia interwalow detekcji: spoczynek i po trafieniu.
- [ ] Dodac ustawienia `post-roll` i liczby minimalnych trafien.

## Profile

- [ ] Dodac profile: `Stabilny`, `Czuly`, `Max detal`.
- [ ] Ustalic konkretne wartosci profili po testach z realnymi nagraniami.
- [ ] Pokazywac aktywny profil w panelu.

## ROI I Kadr

- [ ] Doprecyzowac najlepszy ROI dla podworka z 5 pietra.
- [ ] Rozwazyc wiele ROI tylko jesli jeden prostokat bedzie niewystarczajacy.
- [ ] Pokazywac w statusie rozmiar ROI w pikselach.
...
- [ ] Dodac ustawienie FPS zapisu wideo: `4`, `6`, `8`, `12`.
- [ ] Dodac ustawienie interwalu pelnych zdjec: `1s`, `2s`, `5s`.
- [ ] Zmniejszyc domyslny `post-roll` do zakresu `30-40s` albo wyniesc go do ustawien.
